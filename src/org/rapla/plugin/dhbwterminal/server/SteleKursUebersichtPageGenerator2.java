...
public class SteleKursUebersichtPageGenerator2 extends RaplaComponent implements RaplaPageGenerator, TerminalConstants {
			...
			throws IOException, ServletException 
	{
		...
		try 
		{
			...
			out.println("  <link REL=\"stylesheet\" href=\"kursuebersicht2.css\" type=\"text/css\">");
			...
			allocatableExporter = new CourseExporter2(config, raplaLocale, timezoneConverter,getClientFacade());
